/*
    DESCRIPTION:
    Debian 11 LTS variables using the Packer Builder for VMware vSphere (vsphere-iso).
*/
...
variable "vm_guest_os_version" {
  type        = string
  description = "The guest operating system version. Used for naming. (e.g. '11-lts')"
}
